...
interface ClientLoginModalProps {
  onLoginOpen?: () => void; // Optional callback prop
}

export default function ClientLoginModal({ onLoginOpen }: ClientLoginModalProps) {
  ...
  const handleLoginClick = () => {
    setIsOpen(true);
    if (onLoginOpen) onLoginOpen(); // Call the parent callback if provided
  };
