  ...
  const whyChooseUs = [
    {
      ...
      description: "Enjoy smooth streaming, gaming, and browsing with high-speed connections designed for modern demands."
    },
    {
      title: "Flexible options to fit any budget",
      description: "Access competitive pricing with packages tailored for homes, businesses, and heavy internet users."
    },
    {
      title: "Protection for your data and devices",
      description: "Safeguard your online activities with built-in network security and protection from cyber threats."
    },
    {
      title: "Expert help anytime you need it",
      description: "Receive round-the-clock assistance from our friendly support team for troubleshooting and inquiries."
    }
  ];
    ...
    <div className="bg-white">
      ...
      <section className="relative bg-blue-900 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            Netlink delivers fast, reliable internet with flexible packages and 24/7 support, ensuring seamless connectivity.
          </motion.p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <div className="bg-blue-50 p-6 rounded-lg border border-blue-200 text-center">
                <h3 className="text-3xl font-bold text-blue-600 mb-2">99.9<span className="text-2xl">%</span></h3>
                <h4 className="text-xl font-semibold mb-2">Uptime Guarantee</h4>
                <p className="text-gray-600">Our network reliability ensures you stay connected when it matters most</p>
              </div>
            </motion.div>
          </div>
        </div>
