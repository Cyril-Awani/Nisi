  ...
  const steps = [
    {
      ...
      description: "Enter your location to see if our high-speed internet service is available in your area."
    },
    {
      number: "02",
      title: "Survey Location",
      description: "Our team will visit your location to assess the best setup for optimal internet coverage"
    },
    {
      number: "03",
      title: "Apply Contract",
      description: "Review and sign your service agreement to confirm your chosen plan details."
    },
    {
      number: "04",
      title: "Installation",
      description: "Our certified technicians will install the necessary equipment and quick setup"
    }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                <div className="text-blue-600 text-2xl font-bold mb-4">{step.number}</div>
