    ...
    <div className="bg-white">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            <motion.h2 variants={fadeIn} className="text-3xl font-bold mb-4">Our Mission & Values</motion.h2>
            <motion.p variants={fadeIn} className="text-gray-600 max-w-3xl mx-auto">
              Guiding principles that drive our operations and customer relationships
            </motion.p>
          </motion.div>
            ...
            {[
              {
                ...
                icon: "🛡️",
                description: "We maintain 99.9% network uptime through continuous infrastructure investments and proactive maintenance."
              },
              {
              ...
              },
              {
                ...
                icon: "🚀",
                description: "We constantly explore new technologies to deliver faster speeds and better service at competitive prices."
              }
            ].map((item, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-16 bg-blue-800 text-white">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <motion.h2 variants={fadeIn} className="text-3xl font-bold mb-6">Ready to Experience NISI?</motion.h2>
            ...
            <motion.div variants={fadeIn}>
              <Link
                href="/plans"
                className="inline-block bg-white text-blue-800 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-blue-100 transition"
              >
                View Our Plans
              </Link>
            </motion.div>
